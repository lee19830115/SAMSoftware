...
system/mcapi/GeneratedSources/mcapi_config.doj: ../system/mcapi/GeneratedSources/mcapi_config.c
	...
	cc21k.exe -c -file-attr ProjectName="Automotive_Driver_Test_Framework_Core1" -proc ADSP-SC589 -flags-compiler --no_wrap_diagnostics -si-revision 1.0 -g -DCORE1 -D_DEBUG -DADI_MCAPI -I"C:\Users\Dan\Dropbox\Projects\ADI002 - SS Frameworks\Software\Testing\Automotive Board Driver Testing\Automotive_Driver_Test_Framework_Core1\system" -structs-do-not-overlap -no-const-strings -no-multiline -warn-protos -double-size-32 -char-size-8 -swc -gnu-style-dependencies -MD -Mo "system/mcapi/GeneratedSources/mcapi_config.d" -o "$@" "$<"
